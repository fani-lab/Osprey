...
### 5.2 Backtranslation
We performed our backtranslation experiments based on the use of conversation features in recurrent models, gru and lstm. We augmented the original dataset with different combinations of backtranslations including just a single language, a family of languages related genealogically (french+catalan and deutsch+icelandic), resource richness, and all available langauges. In this table we reported F<sub>0.5</sub>, F<sub>1</sub> and F<sub>2</sub> scores.

<img alt="table of metrics of backtranslation experiments" src="figures/backtranslation-results-table.jpg" width=1000>
