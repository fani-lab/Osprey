...
sessions = {
    "lstm-distilroberta": {
        ...
        "commands": [
            ...
            ("test", {"regex_weights_checkpoint_path": [f"output-earlydetection/lstm-distilroberta/lstm/temporal-nauthor-sequential-embedding/p-v768-filtered-lr0.000500-h512-l1/n{max_passed_messages}/**/model_f*.pth"],
            ...
            ("eval", {"path": f'output-earlydetection/lstm-distilroberta/lstm/temporal-nauthor-sequential-embedding/p-v768-filtered-lr0.000500-h512-l1/n{max_passed_messages}',
